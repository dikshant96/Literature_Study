...
\end{equation}      
Launder extended the model by including modelling of the 'rapid' part which captures the interaction of fluctuating quantities with mean velocity gradient \cite{Wikstrom1998} 