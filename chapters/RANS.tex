...
\end{equation}
The $\Pi_{i\theta}$, $\epsilon_{i\theta}$ and $D_{i\theta}$ terms all introduce additional higher order terms that require modelling to close the full second order tranport equation for scalar fluxes eq:\ref{eq:scalar_transport}. 