...
An alternative to DNS is the Large Eddy Simulation (LES) method where only the large energy containing eddies of turbulence are solved for and the smallest eddies are modelled.% 